...
(function () {
  ...
  var I18N = {
    en: {
      ...
      w6_d: 'Enterprise networks with gateway-level threat management, VLAN segmentation, and continuous monitoring — the infrastructure backbone underneath the software.',
    ...
    es: {
      ...
      w6_d: 'Redes empresariales con gestión de amenazas en el gateway, segmentación por VLAN y monitoreo continuo — la columna de infraestructura debajo del software.',
